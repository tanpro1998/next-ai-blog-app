...
const SocialLinks = ({ isDark = false }: Props) => {
  return (
    <div className="flex justify-between items-center gap-7">
      <a href="https://twitter.com" target="_blank" rel="moreferrer">
        <Image
      ...
      <a href="https://facebook.com" target="_blank" rel="moreferrer">
        <Image
          className={`${isDark ? "brightness-0" : ""} hover:opacity-50`}
          alt="facebook"
          src={Facebook}
      ...
      <a href="https://instagram.com" target="_blank" rel="moreferrer">
        <Image
          className={`${isDark ? "brightness-0" : ""} hover:opacity-50`}
          alt="instagram"
          src={Instagram}
      ...
      <a href="https://google.com" target="_blank" rel="moreferrer">
        <Image
          className={`${isDark ? "brightness-0" : ""} hover:opacity-50`}
          alt="google"
          src={Google}
      ...
      <a href="https://discord.com" target="_blank" rel="moreferrer">
        <Image
          className={`${isDark ? "brightness-0" : ""} hover:opacity-50`}
          alt="discord"
          src={Discord}
