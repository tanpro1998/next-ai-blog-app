...
import { FormattedPost } from "@/app/types/type";
...
const Content = ({ post }: Props) => {
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class:
          "prose prose-sm xl:prose-2xl leading-0 focus:outline-none w-full max-w-full",
      },
    },
    content: content,
    editable: isEditable,
      ...
      <form onSubmit={handleSubmit}>
        ...
        <>
          {isEditable ? (
            <div>
              <textarea
                className="border-2 rounded-md bg-wh-59 p-3 w-full"
                placeholder="Title"
